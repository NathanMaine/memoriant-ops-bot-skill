...
_PYPI_URL = "https://pypi.org/pypi/memoriant-ops-bot/json"
_GITHUB_RELEASES_URL = "https://api.github.com/repos/NathanMaine/memoriant-ops-bot/releases"
_PACKAGE_NAME = "memoriant-ops-bot"
_TIMEOUT = aiohttp.ClientTimeout(total=10)


def get_current_version() -> str:
    """Return the installed version of memoriant-ops-bot."""
    try:
