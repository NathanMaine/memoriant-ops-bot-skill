...
def find_mops_binary() -> str | None:
    """Find the mops binary in PATH. Shared across all backends."""
...
def print_binary_not_found(console: Console) -> None:
    """Print the 'mops binary not found' error."""
...
def print_install_success(
    ...
    *logs_hint* is the description next to ``mops service logs``.
    """
    console.print(
        Panel(
