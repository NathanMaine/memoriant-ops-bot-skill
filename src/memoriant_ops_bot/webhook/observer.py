...
from memoriant_ops_bot.webhook.models import WebhookResult, render_template
from memoriant_ops_bot.webhook.server import WebhookServer
...
class WebhookObserver(BaseTaskObserver):
    ...
    async def start(self) -> None:
        ...
        if not self._config.webhooks.token:
            from memoriant_ops_bot.config import update_config_file_async
