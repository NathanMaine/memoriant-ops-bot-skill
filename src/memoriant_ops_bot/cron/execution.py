...
from memoriant_ops_bot.cli.codex_events import parse_codex_jsonl
from memoriant_ops_bot.cli.gemini_events import parse_gemini_json
from memoriant_ops_bot.cli.gemini_utils import find_gemini_cli
...
def enrich_instruction(instruction: str, task_folder: str) -> str:
    ...
    return (
        ...
        "- The final answer is delivered to Telegram automatically by mops.\n"
