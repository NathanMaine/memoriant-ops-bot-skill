...
from memoriant_ops_bot.cli.timeout_controller import TimeoutConfig as TCConfig
from memoriant_ops_bot.cli.timeout_controller import TimeoutController
from memoriant_ops_bot.cli.types import AgentRequest, AgentResponse
from memoriant_ops_bot.config import NULLISH_TEXT_VALUES, resolve_timeout
from memoriant_ops_bot.i18n import t
from memoriant_ops_bot.infra.inflight import InflightTurn
from memoriant_ops_bot.log_context import set_log_context
from memoriant_ops_bot.orchestrator.hooks import HookContext
from memoriant_ops_bot.orchestrator.registry import OrchestratorResult
from memoriant_ops_bot.session import SessionData, SessionKey
from memoriant_ops_bot.text.response_format import session_error_text, timeout_error_text
from memoriant_ops_bot.workspace.loader import read_mainmemory
...
async def _gemini_missing_config_key_warning(
    ...
    """Warn when Gemini API-key mode is selected but mops config key is empty."""
...
async def normal(
    ...
    *,
    ...
    if warning is not None:
        logger.warning("Gemini API-key mode without configured mops key")
        return warning
