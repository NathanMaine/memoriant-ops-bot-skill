...
from memoriant_ops_bot.background import (
    BackgroundSubmit,
    BackgroundTask,
)
from memoriant_ops_bot.cli.process_registry import ProcessRegistry
from memoriant_ops_bot.cli.service import CLIService, CLIServiceConfig
from memoriant_ops_bot.config import AgentConfig
from memoriant_ops_bot.cron.manager import CronManager
...
from memoriant_ops_bot.infra.inflight import InflightTracker
from memoriant_ops_bot.orchestrator.commands import (
    cmd_cron,
    cmd_diagnose,
    cmd_memory,
    cmd_model,
...
from memoriant_ops_bot.orchestrator.directives import parse_directives
from memoriant_ops_bot.orchestrator.flows import (
    StreamingCallbacks,
    heartbeat_flow,
    named_session_flow,
...
from memoriant_ops_bot.orchestrator.hooks import (
    DELEGATION_BRIEF,
    DELEGATION_REMINDER,
    MAINMEMORY_REMINDER,
    MessageHookRegistry,
)
from memoriant_ops_bot.orchestrator.observers import ObserverManager
from memoriant_ops_bot.orchestrator.providers import ProviderManager
from memoriant_ops_bot.orchestrator.registry import CommandRegistry, OrchestratorResult
from memoriant_ops_bot.security import detect_suspicious_patterns
from memoriant_ops_bot.session import SessionKey, SessionManager
from memoriant_ops_bot.session.manager import SessionData
from memoriant_ops_bot.session.named import NamedSessionRegistry
from memoriant_ops_bot.webhook.manager import WebhookManager
from memoriant_ops_bot.workspace.paths import MopsPaths

if TYPE_CHECKING:
    from memoriant_ops_bot.background import BackgroundObserver
    from memoriant_ops_bot.bus.bus import MessageBus
    from memoriant_ops_bot.config import ModelRegistry
    ...
    from memoriant_ops_bot.session.named import NamedSession
    from memoriant_ops_bot.tasks.hub import TaskHub
...
class Orchestrator:
    ...
    async def create(
        ...
        *,
        ...
        """
        from memoriant_ops_bot.orchestrator.lifecycle import create_orchestrator
    ...
    def register_multiagent_commands(self) -> None:
        ...
        """
        from memoriant_ops_bot.multiagent.commands import (
            cmd_agent_restart,
            cmd_agent_start,
            cmd_agent_stop,
            cmd_agents,
    ...
    def submit_named_session(
        ...
        from memoriant_ops_bot.cli.param_resolver import resolve_cli_config
    ...
    async def _ensure_docker(self) -> None:
        ...
        from memoriant_ops_bot.orchestrator.lifecycle import ensure_docker
    ...
    def _on_config_hot_reload(self, config: AgentConfig, hot: dict[str, object]) -> None:
        ...
        if "language" in hot:
            from memoriant_ops_bot.i18n import init as init_i18n
    ...
    async def handle_interagent_message(
        ...
        *,
        ...
        from memoriant_ops_bot.orchestrator.injection import (
    ...
    async def inject_prompt(
        ...
        *,
        ...
        from memoriant_ops_bot.orchestrator.injection import _inject_prompt
    ...
    async def shutdown(self) -> None:
        ...
        from memoriant_ops_bot.orchestrator.lifecycle import shutdown
