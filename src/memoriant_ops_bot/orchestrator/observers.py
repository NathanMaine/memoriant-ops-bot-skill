...
from memoriant_ops_bot.background import BackgroundObserver, BackgroundResult

if TYPE_CHECKING:
    from memoriant_ops_bot.bus.bus import MessageBus
from memoriant_ops_bot.cleanup import CleanupObserver
from memoriant_ops_bot.cli.codex_cache import CodexModelCache
from memoriant_ops_bot.cli.codex_cache_observer import CodexCacheObserver
from memoriant_ops_bot.cli.gemini_cache_observer import GeminiCacheObserver
from memoriant_ops_bot.cli.service import CLIService
from memoriant_ops_bot.config import AgentConfig, get_gemini_models
from memoriant_ops_bot.config_reload import ConfigReloader
from memoriant_ops_bot.cron.manager import CronManager
from memoriant_ops_bot.cron.observer import CronObserver
from memoriant_ops_bot.heartbeat import HeartbeatObserver
from memoriant_ops_bot.webhook.manager import WebhookManager
from memoriant_ops_bot.webhook.models import WebhookResult
from memoriant_ops_bot.webhook.observer import WebhookObserver
from memoriant_ops_bot.workspace.init import watch_rule_files
from memoriant_ops_bot.workspace.paths import MopsPaths
from memoriant_ops_bot.workspace.skill_sync import watch_skill_sync
...
class ObserverManager:
    ...
    def __init__(self, config: AgentConfig, paths: MopsPaths) -> None:
        self._config = config
        self._paths = paths
    ...
    def wire_to_bus(
        ...
        *,
        ...
        """
        from memoriant_ops_bot.bus.adapters import (
