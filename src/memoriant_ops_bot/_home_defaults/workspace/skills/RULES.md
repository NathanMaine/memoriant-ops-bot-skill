...
This directory is part of mops's three-way skill sync.
...
- Priority when duplicates exist: `mops > claude > codex`.
- Real directories are never overwritten.
- Broken mops-managed links are cleaned automatically.
