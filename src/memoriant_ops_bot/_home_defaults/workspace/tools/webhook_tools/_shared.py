...
from memoriant_ops_bot._home_defaults.workspace.tools._tool_shared import (
    available_ids,
    find_by_id,
...
MOPS_HOME = Path(os.environ.get("MOPS_HOME", "~/.mops")).expanduser()
HOOKS_PATH = MOPS_HOME / "webhooks.json"
CONFIG_PATH = MOPS_HOME / "config" / "config.json"
CRON_TASKS_DIR = MOPS_HOME / "workspace" / "cron_tasks"
