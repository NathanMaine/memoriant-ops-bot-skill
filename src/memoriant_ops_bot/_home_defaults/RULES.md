...
This is the top-level `~/.mops` directory.
...
- `~/.mops/agents.json` is the single source of truth for all sub-agent
...
`~/.mops/SHAREDMEMORY.md` contains facts shared across all agents
