"""Internationalization module for memoriant-ops-bot.

Public API::

    from memoriant_ops_bot.i18n import init, t, t_rich, t_cmd, t_plural
...
from memoriant_ops_bot.i18n.loader import TranslationStore
