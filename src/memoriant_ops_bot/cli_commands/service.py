"""Service management CLI subcommands (``mops service ...``)."""
...
def print_service_help() -> None:
    ...
    table.add_column()
    table.add_row("mops service install", "Install and start background service")
    table.add_row("mops service status", "Show service status")
    table.add_row("mops service start", "Start the service")
    table.add_row("mops service stop", "Stop the service")
    table.add_row("mops service logs", "View live logs")
    table.add_row("mops service uninstall", "Remove the service")
    _console.print(
...
def cmd_service(args: list[str]) -> None:
    """Handle 'mops service <subcommand>'."""
