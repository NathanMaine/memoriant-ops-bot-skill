...
from memoriant_ops_bot.cli.coalescer import CoalesceConfig, StreamCoalescer
from memoriant_ops_bot.messenger.telegram.sender import (
    SendRichOpts,
    send_files_from_text,
    send_rich,
)
from memoriant_ops_bot.messenger.telegram.streaming import create_stream_editor
from memoriant_ops_bot.messenger.telegram.typing import TypingContext
...
if TYPE_CHECKING:
    ...
    from memoriant_ops_bot.config import SceneConfig, StreamingConfig
