...
from memoriant_ops_bot.bus.cron_sanitize import sanitize_cron_result_text
from memoriant_ops_bot.bus.envelope import Envelope, Origin
from memoriant_ops_bot.messenger.matrix.sender import MatrixSendOpts
...
if TYPE_CHECKING:
    from memoriant_ops_bot.messenger.matrix.bot import MatrixBot
...
class MatrixTransport:
    ...
    async def _broadcast(self, text: str) -> None:
        ...
        from memoriant_ops_bot.messenger.matrix.bot import resolve_broadcast_rooms
