...
from memoriant_ops_bot.tasks.models import TaskEntry, TaskInFlight, TaskResult, TaskSubmit

if TYPE_CHECKING:
    from pathlib import Path

    from memoriant_ops_bot.cli.service import CLIService
    from memoriant_ops_bot.config import TasksConfig
...
class TaskHub:
    ...
    def set_agent_paths(self, agent_name: str, paths: MopsPaths) -> None:
    ...
    async def _run(
        ...
        *,
        ...
        from memoriant_ops_bot.cli.types import AgentRequest
