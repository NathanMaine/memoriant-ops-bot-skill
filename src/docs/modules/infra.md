...
- macOS/Windows: file tail from `~/.mops/logs/agent.log` (fallback newest `*.log`)
...
Centralised loading of user-defined API secrets from `~/.mops/.env`.
