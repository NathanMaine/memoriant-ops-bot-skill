...
- Telegram uploads: `~/.mops/workspace/telegram_files/YYYY-MM-DD/`
- Matrix uploads: `~/.mops/workspace/matrix_files/YYYY-MM-DD/`
- API uploads: `~/.mops/workspace/api_files/YYYY-MM-DD/`
