...
from memoriant_ops_bot.cli.types import AgentRequest, CLIResponse
...
async def test_execute_returns_agent_response() -> None:
    ...
    with patch("memoriant_ops_bot.cli.service.create_cli") as mock_create:
        mock_cli = AsyncMock()
...
async def test_execute_streaming_success() -> None:
    ...
    from memoriant_ops_bot.cli.stream_events import AssistantTextDelta, ResultEvent
