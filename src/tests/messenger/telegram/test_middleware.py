...
class TestAuthMiddleware:
    ...
    async def test_allowed_user_passes(self) -> None:
        from memoriant_ops_bot.messenger.telegram.middleware import AuthMiddleware
...
class TestSequentialMiddleware:
    ...
    async def test_sequential_processing(self) -> None:
        from memoriant_ops_bot.messenger.telegram.middleware import SequentialMiddleware
...
class TestIsQuickCommand:
    ...
    def test_is_quick_command(self, text: str, expected: bool) -> None:
        from memoriant_ops_bot.messenger.telegram.middleware import is_quick_command
...
class TestQueueManagement:
    ...
    async def test_stop_kills_active_cli_process(self) -> None:
        ...
        with patch("memoriant_ops_bot.cli.process_registry.asyncio.sleep", new_callable=AsyncMock):
            await mw(AsyncMock(), stop_msg, {})
