...
from memoriant_ops_bot.cli.param_resolver import TaskExecutionConfig, TaskOverrides
from memoriant_ops_bot.config import AgentConfig
from memoriant_ops_bot.cron.execution import OneShotCommand
...
class TestResolveExecutionConfig:
    ...
    def test_resolve_execution_config_no_overrides(
        ...
        with patch("memoriant_ops_bot.infra.base_task_observer.resolve_cli_config") as mock_resolve:
...
class TestExecuteJobWithOverrides:
    ...
    async def test_execute_job_with_model_override(
        ...
        with (
            ...
            patch("memoriant_ops_bot.cron.execution.build_cmd") as mock_build,
            patch("memoriant_ops_bot.infra.base_task_observer.resolve_cli_config") as mock_resolve,
